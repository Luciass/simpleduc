              ...
              if ($user['valide'] == 1) {
                if ($user) {
                  ...
                  if (password_verify($password, $user['mdp'])) {
                    ...
                    <div class="alert alert-danger d-flex align-items-center alert-dismissible mb-0" role="alert">
...
<section>
  ...
  <div class="login-box">
        ...
        <h1>Login</h1>
            ...
            <div class="forgot"><a type="submit" class="" name="forget_pass"><a>Mot de passe oublié</a></div>
            <div class="forgot"><a type="submit" class=""><a href = "/simpleduc/index.php">Retour au menu</a></div>
